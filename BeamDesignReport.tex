...
\tab So\; shear\; reinforcement\; is\; designed\; for\; \\[8pt]
...
\begin{equation*}
 ...
 \end{equation*}
\tab here\; n\; is\; number\; of\; legs\; of\; stirrups \\[8pt]
\begin{equation*}
...
\tab So\; provide\; \var{no_legs_stirrups}-legged\; \var{dia_stirrups}mm\; stirrups\; @\; \var{Sv}mm\; c/c  \\[8pt]
\end{document}
